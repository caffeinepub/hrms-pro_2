                  ...
                  {filtered.map((emp, idx) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge
                          variant="secondary"
                          className={`text-xs ${SHIFT_BADGE_CLASSES[emp.shift] ?? ""}`}
                        >
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        ...
        >
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <Label htmlFor="emp-intime">In Time</Label>
                <Input
                  id="emp-intime"
                  type="time"
                  value={form.inTime}
                  onChange={(e) =>
                    setForm((p) => ({ ...p, inTime: e.target.value }))
                  }
                />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="emp-outtime">Out Time</Label>
                <Input
                  id="emp-outtime"
                  type="time"
                  value={form.outTime}
                  onChange={(e) =>
                    setForm((p) => ({ ...p, outTime: e.target.value }))
                  }
                />
              </div>
            </div>
